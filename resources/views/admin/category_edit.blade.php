                        ...
                        <div class="form-group  ">
                            ...
                            <div class="col-sm-5 basic_info">
                                @if($typeinfos->mid==1)
                                    ...
                                    {{Form::radio('mid', '2',false,array('class'=>"flat-red"))}} 设备列表
                                    {{Form::radio('mid', '3',false,array('class'=>"flat-red"))}} 问答列表
                                @elseif($typeinfos->mid==0)
                                    ...
                                    {{Form::radio('mid', '2', true,array('class'=>"flat-red"))}}  设备列表
                                    {{Form::radio('mid', '3', true,array('class'=>"flat-red"))}}  问答列表
                                @elseif($typeinfos->mid==2)
                                    {{Form::radio('mid', '1', true,array('class'=>"flat-red"))}}  封面频道
                                    {{Form::radio('mid', '0', true,array('class'=>"flat-red"))}}  普通文章
                                    {{Form::radio('mid', '2',false,array('class'=>"flat-red",'checked'=>'checked'))}}  设备列表
                                    {{Form::radio('mid', '3', true,array('class'=>"flat-red"))}}  问答列表
                                @elseif($typeinfos->mid==3)
                                    {{Form::radio('mid', '1', true,array('class'=>"flat-red"))}} 封面频道
                                    {{Form::radio('mid', '0', true,array('class'=>"flat-red"))}} 普通文章
                                    {{Form::radio('mid', '2', true,array('class'=>"flat-red"))}} 设备列表
                                    {{Form::radio('mid', '3',false,array('class'=>"flat-red",'checked'=>'checked'))}} 问答列表
                                @endif
                            </div>
                        </div>
